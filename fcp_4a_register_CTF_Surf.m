...
%     mri_t12ctf_fsl = ft_volumerealign(cfg, t1, mri_brain);
...
%     save(fullfile(mripath,sprintf('%s_transform_t12ctf_n',subj_match.pid{ss})), 'transform_t12acpc');
...
% without acpc
    % freesurfer -> acpc -> ctf
    transform_surf2mri =mri.transform/mri_acpc.transform*mri_t12acpc.transform/mri_t12acpc.transformorig;
    
%     transform_surf2mri = mri_t12acpc.transform/(mri_t12acpc.transformorig/mri.transform);
    
%     transform_surf2mri = mri_t12ctf_fsl.transform/mri.transform;
    
    %example : transform_acpc2ctf = transform_vox2ctf/transform_vox2acpc;
    %                               resliced          move to acpc
    %                                cft         <-     acpc
   
%      transform_surf2mri = mri_t12ctf_fsl.transform/mri_t12ctf_fsl.transformorig;
