...
% FCP_4A_REGISTER_CTF_SURF involves interactive steps to align MEG and MRI 
% scans to facilitate a successful coregistration.
%
% NOTES:
...
for ss = rangeOFsubj
    ...
    % INTERACTIVE: FIND LANDMARKS ON CTF MRI --------------------------------
    % mark AC, PC, right side, superior for better co-registration compatibility
...
%%% REGISTER FreeSurfer T1 -> CTF MRI -------------------------------------
    cfg                 = [];
    cfg.method          = 'spm';
    cfg.spmversion      = 'spm12';
    cfg.viewresult      = 'yes';
    ...
    % get transformation matrix for: freesurfer -> acpc -> ctf
