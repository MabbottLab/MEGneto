function freeviewing_fcp_1_TaskEpoching(paths)
...
%     .bad_chann        = string array; bad channels detected for each ppt 
%     .rejected_trls    = indices of rejected trials
%
...
% initialize output files
    ...
    % record keeping
        ...
        fcp1_output.rejected_trls    = 'rejected_trls.mat';
...
%%% ARTIFACT REJECTION ----------------------------------------------------
        ...
        fcp1_output.rejected_trlInd{ss,1}   = cfg.trl_rejected;
        trls_rejected                       = cfg.trl_rejected;
        save([paths.(subj_match.pid{ss}) '/' fcp1_output.rejected_trls], 'trls_rejected', '-v7.3');
    end
