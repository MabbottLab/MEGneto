function [cfg] = freeviewing_ft_rejectartifact(cfg, data)
...
addpath /mnt/hpc-megneto/fieldtrip_private;
...
cfg.trlrejected = trlCompletelyRemovedInd; % this line was added in the freeviewing analysis to mark removed trials
