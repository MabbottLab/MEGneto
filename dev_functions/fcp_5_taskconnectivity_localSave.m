function fcp_5_taskconnectivity_localSave(paths)
...
%%% SAVE PARTICIPANT'S CONNECTIVITY MATRIX -----------------------------------
        ...
        save(['/home/kwalonso/TP/' subj_match.pid{ss} '/fcp_5_conn_mat_' config.connectivity.method '.mat'],'conn_mat','-mat','-v7.3')
...
save(['/home/kwalonso/TP/fcp_5_allParticipants_conn_mats_' config.connectivity.method '.mat'],'all_conn_mat','-v7.3');
