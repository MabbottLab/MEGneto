...
definput                  = {contact_epoching_definput,...
                             ...
                             taskFunc_definput, task_definput,...
                             beamforming_definput,...
                             beamforming2_definput,...
                             beamforming3_definput, connectivity_definput};
...
%% grabbing input
for cfg_part = 1:10
    answers = inputdlg(prompt{cfg_part}(2:end), dlg_title{cfg_part}, dims, definput{cfg_part});
    switch cfg_part
        case 1
