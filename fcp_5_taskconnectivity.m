...
%%% CALCULATE CONNECTIVITY ------------------------------------------------
            ...
            cfg.keeptrials  = 'yes';
            cfg.taper       = 'hanning';
            if config.connectivity.filt_freqs(fq,2) - config.connectivity.filt_freqs(fq,1) > 10
                cfg.foi     = config.connectivity.filt_freqs(fq,1):2:config.connectivity.filt_freqs(fq,2);
            else
