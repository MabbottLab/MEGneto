...
% run analysissurf_path = '/home/megneto/data/sbells/meg_freesurfer/processed_freesurfer';

fcp_1_RestingStateEpoching(paths)

%% fcp_2: ICAsurf_path = '/home/megneto/data/sbells/meg_freesurfer/processed_freesurfer';


% write PIDs to appropriate *.csv, ASSUMING no change in participants to be
% analyzedsurf_path = '/home/megneto/data/sbells/meg_freesurfer/processed_freesurfer';
...
%% fcp_2_5: INTERACTIVE - identifies bad ICA components, reject those components
...
% specify path to freesurfer surfaces
surf_path = '/home/megneto/data/sbells/meg_freesurfer/processed_freesurfer';
