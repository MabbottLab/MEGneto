...
projdir = '/data2/connectivity_study/nbs_analysis2/visualNetwork/';
file_in = strcat(projdir, '/NBS_101-150Hz.mat');
% 
...
all_sbj = zeros(10,48);
all_temp_mask_beta = zeros(10,10,48);

for ss = 1:length(subj)
   
    temp_beta = tempFile(:,:,ss);
    temp_mask_beta = temp_beta.*maskB.adj;
    all_temp_mask_beta(:,:,ss) = temp_mask_beta;
    [str] = strengths_und(temp_mask_beta);
