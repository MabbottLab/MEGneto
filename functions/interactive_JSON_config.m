...
prompt{10}    = {'Do you wish to generate functional connectivity results (0 for no, 1 for yes)',...
                 ...
                 'Specify ROIs you wish to include in the analysis or ROIs you wish to collapse into supra-ROIs. The example below is for the latter, for the former use the format [1];[2];[3] and so on. Leave as blank if all ROIs should be included.'};
prompt{11}    = {'Do you wish to perform time frequency analysis (0 for no, 1 for yes)',...
                 ...
                 'Specify a subset ROIs you wish to include in the analysis or ROIs you wish to collapse into supra-ROIs. The example below is for the latter, for the former use the format [1];[2];[3] and so on. Leave as blank if all ROIs should be included.'};
