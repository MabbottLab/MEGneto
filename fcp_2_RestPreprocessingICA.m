function fcp_2_RestPreprocessingICA(paths)

% FCP_2_RESTPREPROCESSINGICA will prepare epoched data for ICA preprocessing,
...
% setup participants to be analyzed
...
%%% FILTER DATA -----------------------------------------------------------
             ...
             % if gradiometers exist, then load them
...
% remove participants who were requested for fcp_1 but not fcp_2
